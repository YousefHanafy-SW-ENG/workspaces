      ...
      listener: (context, state) {
        ...
        if(state is BookingErrorState){
          Fluttertoast.showToast(
            msg: AppStrings.bookingErrorMsg,
      ...
      builder: (context, state) {
        return ButtonBottomNavBar(
          button: PrimaryButton(
            ...
            fillColor: cubit.notEmptyFields ? AppColors.blueColor : AppColors
                .greyColor2,
            borderColor: cubit.notEmptyFields ? AppColors.blueColor : AppColors
                .greyColor2,
            textColor: cubit.notEmptyFields ? Colors.white : AppColors
                .greyColor3,
            onTap: ()=>cubit.confirmBooking(),
          ),
        );
      },
    );
